...
export const products: Product[] = [
  ...
  },
  {
    ...
    sizes: [
      { weight: "20g", calories: 92, protein: 2, carbs: 20, fat: 0, price: 5.99, pricePEN: 10 },
      { weight: "45g", calories: 208, protein: 4, carbs: 45, fat: 0, price: 8.99, pricePEN: 22 },
    ],
  },,
  {
    id: "14",
    name: "Arroz con Pollo",
    description: "Peru's beloved rice and chicken — slow-cooked with ají amarillo, cilantro, and green peas. Fragrant, hearty, and deeply comforting.",
    price: 11.99,
    pricePEN: 40,
    image: "/arroz.jpg",
    category: "high-protein",
    ...
    ingredients: [
      ...
      { name: "Green Peas", region: "Cusco", x: 50, y: 60 },
    ],
  },
  {
    id: "15",
